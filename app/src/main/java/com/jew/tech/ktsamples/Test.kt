...
data class Test(var name:String="test",var passwd:String="123456")

fun printTest(test:Test){
    val name = test.name
    var passwd = test.passwd

    fun innerPrint(){
        println("name: $name, passwd:$passwd")
    }
    innerPrint()
}

infix fun String.test(x:Int){
    println("test,$x")
}
